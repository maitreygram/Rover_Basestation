...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roboclaw_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/utkarsh/rover_ws/install/${idir}'.  Ask the maintainer 'Brad Bazemore <bwbazemore@uga.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/utkarsh/rover_ws/install/lib;/opt/ros/indigo/lib)
